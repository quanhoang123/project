                        ...
                        <div class="slider slider-single">
                            ...
                            <div>
                                <?php
                                    ...
                                    $getAll = $dt->select($sql);
                                    foreach ($getAll as $wedđing) {
                                ?>
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                                    <div class="offer-item">
                                        <img src="<?php echo $wedđing['image']?>" alt="" class="img-responsive">
                                        <div>
                                            <h3><?php echo $wedđing['name']?></h3>
                                            <p>
                                            <?php echo $wedđing['description']?>
                                            </p>
                                        </div>
                                        <span class="offer-price">$<?php echo $wedđing['price']?></span>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
